    ...
    <nav class="sidebar-nav">
      <ul>
        ...
        <li class="nav-item nav-item-has-children">
          <a href="/userdashboard" class="collapsed" data-bs-toggle="collapse" data-bs-target="#ddmenu_3" aria-controls="ddmenu_3"
          ...
          <ul id="ddmenu_3" class="collapse dropdown-nav">
            <li>
              <a href="/userdashboard"> View Requests </a>
            </li>
            <li>
        ...
        <!-- Contacts -->
        <li class="nav-item nav-item-has-children">
          <a href="/userdashboard" class="collapsed" data-bs-toggle="collapse" data-bs-target="#ddmenu_4" aria-controls="ddmenu_4"
            aria-expanded="false" aria-label="Toggle navigation">
            <span class="icon">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <ul id="ddmenu_4" class="collapse dropdown-nav">
            <li>
              <a href="{{ route('contacts_user') }}"> View Messages </a>
            </li>
            <li>
              <a href="{{route('contact')}}#contact">Sent Messages </a>
            </li>
          </ul>
        </li>
        <span class="divider">
        ...
        <a href="/userdashboard" class="collapsed" data-bs-toggle="collapse" data-bs-target="#ddmenu_4" aria-controls="ddmenu_4"
            ...
            <span class="text">Your Info</span>
          </a>
          <ul id="ddmenu_4" class="collapse dropdown-nav">
            <li>
            ...
            <li>
            <a href="">Account Created: {{auth()->user()->created_at->format('M d, Y') }}</a>
            </li>
          </ul>
              ...
              <div class="profile-box ml-15">
                <button class="dropdown-toggle bg-transparent border-0" type="button" id="profile"
                  ...
                  <div class="profile-info">
                    <div class="info">
                      <div class="image">
                        <img src="{{ asset('images/favicon.png') }}" style="width: 45px; height: 45px;"
                          alt="image" />
                      </div>
                      <div>
                        <h6 class="fw-500">Mofat User</h6>
                        <p>{{ auth()->user()->name }}</p>
                      </div>
                    </div>
                  </div>
        ...
        <div class="row">
          <div class="col-md-6 order-last order-md-first">
            <div class="copyright text-center text-md-start">
              <p class="text-sm">
                Mofat Logistics Limited &copy; 2025
              </p>
            </div>
          </div>
          <!-- end col-->
          <div class="col-md-6">
            <div class="terms d-flex justify-content-center justify-content-md-end">
              <a href="/" class="text-sm ml-15">Mofat Website</a>
            </div>
          </div>
        </div>
        <!-- end row -->

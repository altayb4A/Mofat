            ...
            <div class="col-lg-5 md-mb-40px"
                ...
                <div class="position-sticky top-120px md-top-0px md-position-relative">
                    <span
                        ...
                        to know us</span>
                    <h2 class="text-dark-gray mb-20px fw-700 ls-minus-1px">Locations across The UK.</h2>
                        ...
                        <div class="row g-0 box-shadow-quadruple-large border-radius-6px overflow-hidden">
                            <div class="col-lg-6 col-sm-6">
                                <div class="h-100 cover-background xs-h-300px"
                                    style="background-image: url(images/Man.png)"></div>
                            </div>
                            <div class="col-lg-6 col-sm-6 bg-white box-shadow-extra-large p-30px">
                                <div class="services-box-content last-paragraph-no-margin">
                                    <span class="d-block text-dark-gray fw-700 fs-19 mb-10px">Manchester</span>
                                    <p>32 Rodney Street Salford 
M3 5HG.</p>
                                    ...
                                    <div class="text-dark-gray fw-600"><i
                                            ...
                                            href="tel:+234 805 906 5288">+44 7723166744</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col services-box-style-02 mb-30px">
                        <div class="row g-0 box-shadow-quadruple-large border-radius-6px overflow-hidden">
                            <div class="col-lg-6 col-sm-6">
                                <div class="h-100 cover-background xs-h-300px"
                                    style="background-image: url(images/Cardiff.png)"></div>
                            </div>
                            <div class="col-lg-6 col-sm-6 bg-white box-shadow-extra-large p-30px">
                                <div class="services-box-content last-paragraph-no-margin">
                                    <span class="d-block text-dark-gray fw-700 fs-19 mb-10px">Manchester</span>
                                    <p class="lh-22 mb-25px">32 Rodney Street Salford 
M3 5HG
                                    </p>
                                    ...
                                    <div class="text-dark-gray fw-600"><i
                                            class="feather icon-feather-phone-call icon-small me-10px text-dark-gray"></i><a
                                            href="tel:+234 805 906 5277">+44 7723166744</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-very-light-gray p-8 border-radius-10px">
                    <div class="row">
                        <div class="col-12 text-center mb-6">
                            ...
                            <h2 class="text-dark-gray mb-0 fw-700 ls-minus-1px">How may we help you?</h2>
                        </div>
                    </div>
                    <!-- start contact form -->
                    @if(session('success'))

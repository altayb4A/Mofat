                        ...
                        <table class="table top-selling-table">
                            <thead>
                                <tr>
                                    ...
                                    <th><h6 class="text-sm text-medium">Delete</h6></th>
                                    <th><h6 class="text-sm text-medium">Edit</h6></th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse ($estimates as $estimate)
                                <tr>
                                    <td><p class="text-sm">MO{{ $estimate->id }}25</p></td>
                                    ...
                                    <td>
                                        ...
                                        <td>
                                        <div>
                                  <a href="{{ url('edit-estimate/'.$estimate->id) }}" class=" btn btn-xs btn-primary"style="background-color: #00165B">Edit</a>  
